      ...
      
      {
        ...
        <label htmlFor='image'>
          <div className='inline-block relative cursor-pointer'>
            <img className='w-36 h-36 rounded-full object-cover border-2 border-blue-300' src={image? URL.createObjectURL(image): userData.image} alt="profile" />
